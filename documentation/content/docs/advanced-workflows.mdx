...
This guide covers advanced PrStack patterns for complex development scenarios.
...
The megamerge workflow uses feature bases to develop large features with multiple parallel work streams, then merge everything at once.
...
### Use Cases for Megamerge

- **Major version releases**: v1 → v2 rewrites
- **Large architectural changes**: Microservices migration, framework upgrades
- **Feature flags**: Develop complete features behind flags, merge all at once
- **Coordinated releases**: Multiple teams working on components for a single release

## Rebasing Strategies

PrStack is **rebase-agnostic** and doesn't prescribe how you manage your commit history. You can use whatever rebasing strategy you prefer with your VCS tools.

> **Note**: PrStack focuses on PR management, not commit history. Use your favorite tools (Git, Jujutsu, interactive rebase, etc.) to manage your tree structure.
